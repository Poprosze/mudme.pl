...
{block name='product_miniature_item'}
  ...
  <div
    ...
    >
    <article
      class="product-miniature js-product-miniature p-2 h-100 {block name='product_miniature_item_class'}{/block}"
      ...
      <div class="product-miniature__hover">
        <div class="hover-expander"></div>
