...
{if $status == 'ok'}
    <p>
        {l s='Your order on #kaloszepoprosze is complete.' d='Modules.Wirepayment.Shop'}<br/>
    ...
    <p>
        {l s='Please specify your order reference [1]%s%[/1] in the bankwire description.' sprintf=[  '[1]' => '<strong>#',
        '[/1]' => '</strong>',
        '%s%' =>
        $reference] d='Modules.Wirepayment.Shop'}<br/>
