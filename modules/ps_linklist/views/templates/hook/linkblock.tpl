 ...
 *}
  ...
  {foreach $linkBlocks as $linkBlock}
    <div class="link-block link-{$linkBlock.hook}">
      {assign var=_expand_id value=10|mt_rand:100000}
      <div class="link-block__header position-relative">
      ...
      <div id="footer_sub_menu_{$_expand_id}" class="collapse d-md-block link-block__content">
        <ul class="links-list">
